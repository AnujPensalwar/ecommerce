...
export const getOrderHistoryFailure = createAction(
 ...
 export const getUserOrdersRequest = createAction(
  '[Order] Get User Orders Request'
);

export const getUserOrdersSuccess = createAction(
  '[Order] Get User Orders Success',
  props<{ payload: any }>()
);

export const getUserOrdersFailure = createAction(
  '[Order] Get User Orders Failure',
  props<{ error: any }>()
);